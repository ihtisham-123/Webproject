                ...
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:flex space-x-8">
                        {navItems.map((item) => (
                            <div
                                key={item.path}
                                className="text-gray-600 font-bold hover:text-gray-900 cursor-pointer 
                    ...
                    <div className="hidden md:flex font-bold items-center space-x-4">
                        <button
                            ...
                            className="px-8 py-2 rounded-md bg-gradient-to-r from-[#3E62DE] to-[#B22ADF] text-white
                            hover:from-[#B22ADF] hover:to-[#3E62DE] transition-all duration-200"
                          >
                            Sign up
                        </button>
                        <button
                            ...
                            text-white bg-gradient-to-r from-[#3E62DE] to-[#B22ADF] hover:from-[#B22ADF] hover:to-[#3E62DE] 
